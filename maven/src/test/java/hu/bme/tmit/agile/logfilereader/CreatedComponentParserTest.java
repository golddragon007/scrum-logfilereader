...
public class CreatedComponentParserTest {
	...
	public void testCreatedComponent() {
		...
		assertEquals(CreatedComponentParser.parseCreatedComponent(testParts).getComponentType(),
		...
		assertEquals(CreatedComponentParser.parseCreatedComponent(testParts).getComponentEventType(),
				ComponentEventType.Create);
	}
}